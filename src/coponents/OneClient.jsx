...
export default function OneClient({client}) {
  return (
  <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ml-3  hover:scale-110 transition duration-300">
